...
# Esecuzione dei comandi nelle sottofinestre
tmux send-keys -t PT:4.0 "xdg-open \"https://securityheaders.com/\" & xdg-open \"https://www.ssllabs.com/ssltest/\" & xdg-open \"https://www.social-searcher.com/\" # get info from site"
cd $folderProject
